...
%% Tests
-export([t_default_replicas/1,
         t_explicit_replicas/1,
         t_join_leave/1]).
...
all() ->
  [t_default_replicas, t_explicit_replicas, t_join_leave].
...
t_default_replicas(_Config) ->
  ...
  ct:print("\e[1;1m t_default_replicas \e[0m\e[32m[OK] \e[0m"),
  ok.

t_explicit_replicas(_Config) ->
  %% Set
  ...
  ct:print("\e[1;1m t_explicit_replicas \e[0m\e[32m[OK] \e[0m"),
  ok.
...
t_join_leave(Config) ->
  ...
  ct:print("\e[1;1m t_join_leave \e[0m\e[32m[OK] \e[0m"),
  ok.
